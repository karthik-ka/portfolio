...
import "./About.scss"
import Rotate from "../../assets/frontend.png";
      ...
      <div className="about__container grid ">
        <div className="about__img" data-aos="fade-up">
          <span className="stamp" >
            <img src="https://stefantopalovicdev.vercel.app/static/media/text2.3d5aa6ba2d0632bb4e0572631c3f9dc2.svg" alt="" className="stamp-text"/>
