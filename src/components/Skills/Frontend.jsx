...
const Frontend = () => {
  ...
  return (
    <div className="skill" data-aos="fade-up">
      <h1 className="skill__title">Frontend</h1>
      <div className="skill__area grid">
        ...
        <span className="language">
          <svg viewBox="0 0 128 128" className="language__icon">
            ...
            <p className="language__name">Redux-toolkit</p>
        </span>
        ...
        <span className="language">
          ...
          <p className="language__name">Tailwind css</p>
        </span>
        ...
        <svg viewBox="0 0 128 128" className="language__icon">
          ...
          <p className="language__name">Sass</p>
        </span>
